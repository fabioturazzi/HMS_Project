...
<body>
	...
	<div class="container">
		...
		<form:form action="${pageContext.request.contextPath}/updateFacility/"
			cssClass="form-horizontal" method="post" modelAttribute="facility">
			<c:if test="${ errorMessage !=null }">
				<div class="alert alert-danger">${errorMessage}</div>
			</c:if>
			<div class="form-group" hidden>
				<label for="facilityId" class="col-md-3 control-label">Facility
					Id</label>
				<div class="col-md-9">
					<form:input path="facilityId" cssClass="form-control"
